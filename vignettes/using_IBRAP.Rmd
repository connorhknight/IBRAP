...
marrow_A <- readRDS('/Users/knight05/work/Results/scRNA-seq/IBRAP_tutorials/single_sample/marrow_A.rds')
...
marrow_A <- perform.scrublet(counts = marrow_A)
...
marrow_A <- perform.decontX(counts = marrow_A)
...
DE_res <- readRDS('/Users/knight05/work/Results/scRNA-seq/IBRAP_tutorials/single_sample/marrow_A_DE.rds')
