...
marrow_A <- readRDS('/Users/knight05/work/Results/scRNA-seq/IBRAP_tutorials/tmp/marrow_A.rds')
...
```{r, include=T, out.width="200%", out.height="150%"}
...
```{r, include=T, out.width="200%", out.height="300%"}
...
```{r, eval=F, echo=T, out.width="150%", out.height="150%"}
