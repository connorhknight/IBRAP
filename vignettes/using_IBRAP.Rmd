...
Droplet-based datasets typically contain multiples (dorplets that contain two or more cells. To circumvent this, we included Scrublet. This can be performed using the following command:
...
We have also included a function that adopts decontX which allows users to identify ambient RNA and in droplets and to remove it. However this is not installed automatically and requires the use of the [decontX](https://connorhknight.github.io/IBRAP/) tutorial to use it. 
