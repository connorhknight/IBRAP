...
Data transformation in IBRAP incorporates multiple steps from packages:
 - counts normalisation which redistributes data to fit a normal distribution
 - most genes in the dataset do not exhibit much variation and thus facilitate a fake closeness between cells and wastes computational resources. Therefore, highly variable genes are subset in decreasing order to a cut-off. Default = 1500
 - 
